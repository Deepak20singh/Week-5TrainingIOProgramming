package com.ioprogramming.jsondata.ipl;
...
public class IPL {
        ...
        public static void main(String[] args) {
            // Process JSON file
            List<Map<String, Object>> jsonData = readJSON("src/main/java/com/ioprogramming/jsondata/ipl/ipl_matches.json");
            if (jsonData != null) {
                List<Map<String, Object>> cleanedJsonData = applyCensorship(jsonData);
                writeJSON("src/main/java/com/ioprogramming/jsondata/ipl/ipl_matches_sanitized.json", cleanedJsonData);
            }

            List<String[]> csvData = readCSV("src/main/java/com/ioprogramming/jsondata/ipl/ipl_matches.csv");
            if (csvData != null) {
                List<String[]> cleanedCsvData = applyCensorshipCSV(csvData);
                writeCSV("src/main/java/com/ioprogramming/jsondata/ipl/ipl_matches_sanitized.json", cleanedCsvData);
            }

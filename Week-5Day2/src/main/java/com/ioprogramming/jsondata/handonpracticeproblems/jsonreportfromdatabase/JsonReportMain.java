package com.ioprogramming.jsondata.handonpracticeproblems.jsonreportfromdatabase;
...
public class JsonReportMain {
    public static void main(String[] args) {
          String csvFile = "src/main/java/com/ioprogramming/jsondata/handonpracticeproblems/jsonreportfromdatabase/data.csv";  // Simulated DB data
